...
public class Persona {
     ...
     * Se pasa por parametro el id del usuario, cargamos  los usuarios de la base de datos en un arraylist
     * y lo comprobamos. devolvera un boolean en funcion de si existe o no
     * @param id
     * @return
     * @throws ClassNotFoundException
     * @throws SQLException
     */
    public static boolean existeUsuario(String id) throws ClassNotFoundException, SQLException {
    	boolean existe = false;   	
    	ArrayList <Persona> listaPersonas = BBDD.recuperarPersonas();
