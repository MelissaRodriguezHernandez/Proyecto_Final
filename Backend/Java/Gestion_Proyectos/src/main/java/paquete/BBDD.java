	 ...
	 /**
	    ...
	    */
	    ...
	    public static String infoTareaFaseUsuario(String idFase) throws ClassNotFoundException, SQLException {
	        ...
	        while(rs.next()) {
	            resultado = resultado + "<h4 id="+rs.getString("idTarea")+">"+rs.getString("nombre")+" | entrega : "+rs.getString("fechaEntrega")+"<i class=\"icon icon-square-o\" onclick=\"actualizarEstadoTarea("+rs.getString("idTarea")+", "+idFase+")\"></i><br><span> Descripción | "+rs.getString("descripcion")+"</span></h4>";
	        }
	     ...
	     *Este es llamado cuando se añade la primera fase del proyecto
	     * @throws ClassNotFoundException
	     * @throws SQLException
	     */
